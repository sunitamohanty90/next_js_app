...
const Addabout = () => {
    ...
    const CreateAbout = async event => {
        ...
        // imageUpload()
            ...
            await axios.post('http://localhost/api/createabout',data,
    ...
    <div className="flex justify-center items-center">  
        <div className="flex flex-col bg-white p-8 rounded-xl">
            <form onSubmit={CreateAbout}>
                 <div className="">
                   <h2 className="text-blue-600 text-3xl font-weight-800">Create About</h2>
                     ...
                     <div className="flex flex-col p-4 rounded-xl">
                          ...
                          <button className=" bg-blue-600 hover:bg-blue-700 text-white my-2 py-1 rounded-xl w-72" type="submit">Create</button>
